...
- `client/src/lib/engine.ts` - computeRunway(), computeScenarios(), computeSpendingImpact(), computeSensitivity()
...
- `client/src/pages/wizard.tsx` - 5-step financial data input wizard
- `client/src/pages/preview.tsx` - Free preview showing approximate runway
- `client/src/pages/results.tsx` - Full results dashboard with 6 tabs
